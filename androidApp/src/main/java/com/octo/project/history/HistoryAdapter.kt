...
class HistoryAdapter(private val items: MutableList<History>, private val context: Context): RecyclerView.Adapter<HistoryAdapter.ViewHolder>()  {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.rate.text = context.getString(R.string.history_value, items[position].originValue,
